  ...
  <div class="row justify-content-center .align-items-center mt-2">
    <div
      ...
      <div class="row justify-content-between">
        <div class="col-8">
          ...
          <!--button title="Copy response to clipboard" data-bs-toggle="tooltip" data-bs-placement="top"
            class="btn btn-outline-warning" @click="gen.copyOutput()" v-show="gen.response"">Copy
          </button-->
          <button class=" btn btn-outline-warning" @click="clearOutput()" v-show="gen.response">Clear
      ...
      <div class="input-group my-2">
        <button class="input-group-text bg-warning text-dark" id="basic" v-show="gen.disable">
          <span class="spinner-border spinner-border-sm" aria-hidden="true">
          </span>
        </button>
        <input class="form-control" placeholder="I'm your AI Assistant, chat with me!" v-model="gen.prompt"
          @keyup.enter="gen.getChat()" autofocus>
        <button class="input-group-text bg-warning text-dark" id="basic" @click="gen.getChat()" v-show="!gen.disable">
          <i class="bi bi-play-fill"></i>
        </button>
        <button class="input-group-text bg-warning text-dark" v-show="gen.disable" @click="gen.stopGen()">
