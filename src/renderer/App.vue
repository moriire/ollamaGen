  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-lg-3 d-none col-lg-block d-none d-lg-block  bg-dark vh-100 px-4 py-4"
        ...
        <RouterLink class="navbar-brand text-warning mt-3 text-decoration-none" to="/">
        ...
        <div class="nav flex-column nav-pills nav-warning me-3 mt-4" role="tablist" aria-orientation="vertical">
          ...
          <div class="col-lg-12 my-2">
            ...
            <div class="d-block">
              ...
              <div class="d-flex justify-content-between  px-2 text-light .btn-outline-warning align-items-center">
                Inference Parameter
